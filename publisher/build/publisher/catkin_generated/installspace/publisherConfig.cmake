...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'publisher' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ros/workingSpaces/publisher/install/${idir}'.  Ask the maintainer 'ros <ros@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ros/workingSpaces/publisher/install/lib;/home/ros/workingSpaces/publisher/devel/lib;/opt/ros/indigo/lib)
