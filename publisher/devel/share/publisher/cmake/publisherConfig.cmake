...
if("TRUE" STREQUAL "TRUE")
  set(publisher_SOURCE_PREFIX /home/ros/workingSpaces/publisher/src/publisher)
  set(publisher_DEVEL_PREFIX /home/ros/workingSpaces/publisher/devel)
  ...
  set(publisher_INSTALL_PREFIX /home/ros/workingSpaces/publisher/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'publisher' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'ros <ros@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'publisher' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ros/workingSpaces/publisher/src/publisher/${idir}'.  Ask the maintainer 'ros <ros@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/ros/workingSpaces/publisher/devel/lib;/home/ros/workingSpaces/publisher/devel/lib;/opt/ros/indigo/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${publisher_dep}_FOUND)
      find_package(${publisher_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${publisher_dep} REQUIRED ${depend_list})
  endif()
